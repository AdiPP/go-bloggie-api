...
//Source : https://github.com/bluele/zapslack
...
func NewSlackHook(hookURL string, level zapcore.Level, appName string) *SlackHook {
	return &SlackHook{
		HookURL:        hookURL,
